...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["menu_item"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["resource_item"]) {
                ...
                echo "><a href=";
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["resource_item"], "url", array()), "html", null, true));
                echo ">";
...
";
    ...
    {
        return array (  87 => 16,  79 => 13,  66 => 11,  62 => 10,  57 => 8,  54 => 7,  52 => 6,  47 => 4,  43 => 2,);
    }
          ...
          <span class=\"dropdown\">
            <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-expanded=\"false\">{{ menu_item.text }}<span class=\"caret\"></span></a>
                <ul class=\"dropdown-menu\" role=\"menu\">
                  ...
                  <li value={{ resource_item.text|replace({' ': ''}) }}><a href={{ resource_item.url }}>{{ resource_item.text }}</a></li>
                  {% endfor %}
                </ul>
           </span> 
        {% endfor %}
