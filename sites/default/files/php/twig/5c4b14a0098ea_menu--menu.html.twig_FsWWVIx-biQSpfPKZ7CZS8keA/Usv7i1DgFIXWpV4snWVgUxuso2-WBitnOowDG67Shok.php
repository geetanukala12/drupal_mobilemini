...
";
    ...
    {
        return array (  122 => 53,  114 => 50,  106 => 47,  94 => 43,  91 => 42,  87 => 41,  79 => 39,  75 => 38,  70 => 36,  67 => 35,  65 => 34,  61 => 33,  57 => 32,  51 => 28,  48 => 23,  46 => 22,  43 => 21,);
    }
                  ...
                  <li value={{ resource_item.text|replace({' ': ''}) }}><a href=\"#\">{{ resource_item.text }}</a>
                            <table>
                                {% for resource_sub_menu in resource_item.submenu %}
                                     <tr>
                                    <td value={{ resource_sub_menu.text|replace({' ': ''}) }}><a href=\"#\">{{ resource_sub_menu.text }}</a>
                                    </td>
                                    </tr>
                                {% endfor %}
                            </table>
